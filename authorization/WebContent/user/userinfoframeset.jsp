...
<frameset cols="*,1024,*" frameborder="no" border="0" framespacing="0">
	...
	<frameset rows="100,*,100" cols="*" frameborder="no" border="0" framespacing="0">
	  ...
	  <frameset cols="200,*" frameborder="no" border="0" framespacing="0">
		<frame src="user/userinfoleft.jsp" name="leftFrame" scrolling="auto" noresize="noresize" id="leftFrame" />
		<frame src="user/userinfomain.jsp" name="mainFrame" id="mainFrame"  scrolling="auto"/>
	  </frameset>

				...
				<table width="800px;" bgcolor="#CCCCCC" border="0" cellspacing="1" cellpadding="1" class="contTable">
					...
					<tr>
						<td align="center">
						    ...
						    <input type="button" onclick="queryWebInfoByAuthorization()" class="txtInp" style="width: 60px;" value="<fmt:message key='look_up_button'/>" />&nbsp;&nbsp; 
						</td>
					</tr>
				</table>
			</td>
	...
	<br>
	 <div align="center" style="width: 800px;">
	 	<jsp:include page="../pagination.jsp">
	 		<jsp:param value="admin/authorizedWebList" name="url"/>
	 	</jsp:include>
	 </div>
</form>
</body>

...
/*	function showWebapiById(id){
		$.post("judgeIsAuthorizedByWebapiId", {webapiId:id},function(data){
			if(data == "false"){
				...
				$.post("countWebapiRequestTimes", {webapiId:id},function(data){},"text");
			}
		},"text");
	}*/
				...
				<table width="810px;" bgcolor="#CCCCCC" border="0" cellspacing="1" cellpadding="1" class="contTable">
					...
					<tr>
						<td align="center">
							...
							<input id="apiName" type="text" name="apiName" style="width: 150px;line-height: 15px;height: 15px;">
	...
	<br>
	  <div align="center" style="width: 810px;">
	 	<jsp:include page="../pagination.jsp">
	 		<jsp:param value="common/queryWebapiListByapiName" name="url"/>
	 	</jsp:include>
	 </div>
</form>
</body>

				...
				<table width="810px;" bgcolor="#CCCCCC" border="0" cellspacing="1" cellpadding="1" class="contTable">
					...
					<tr>
						<td align="center">
						    ...
						    <input type="button" onclick='queryWebInfoListByWebName()' class="txtInp"  value="<fmt:message key="look_up_button"/>" style="width: 60px;"/>&nbsp;&nbsp; 
						</td>
					</tr>
				</table>
			</td>
	...
	<br>
	 <div align="center" style="width: 810px;">
	 	<jsp:include page="../pagination.jsp">
	 		<jsp:param value="common/webInfoList" name="url"/>
	 	</jsp:include>
	 </div>
</form>
</body>
